/**
 * MedBlock — Password Strength Meter + Caps Lock Warning
 * Ported from Login Project's PasswordStrength.tsx to plain JSX.
 *
 * Features:
 *  ✅ 4-step strength bar
 *  ✅ Criteria tips (8+ chars, upper+lower, digit, special char)
 *  ✅ Caps Lock warning when caps lock is active
 */
    ...
    <div className="pw-strength" style={{ marginTop: 8 }}>
      ...
      <div className="pw-tips" style={{ marginTop: 8, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4px 10px' }}>
        {[
          ...
          <div
            key={label}
            style={{ display: 'flex', alignItems: 'center', gap: 5, fontSize: '0.7rem', color: ok ? '#10b981' : 'var(--muted)' }}
          >
...
export function CapsLockWarning({ active }) {
